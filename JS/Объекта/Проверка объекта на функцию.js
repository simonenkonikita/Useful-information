...
🔶Функцию (counter), будет считать, сколько раз её вызвали, и возвращать это число как результат. Количество вызовов функции можно сохранить в её свойстве, которое можно назвать, к примеру, counter.times:

function counter() {
  /* если такого свойства ещё нет,
  значит это первый вызов — создадим его */
  if (!counter.times) {
  counter.times = 0;
}
/* увеличим на единицу */
